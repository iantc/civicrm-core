  ...
  {strip}
    ...
    {foreach from=$fields item=field key=fieldName}
      ...
      {if $field.groupTitle != $fieldset}
        ...
        {/if}
          ...
          {if $form.formName eq 'Confirm' OR $form.formName eq 'ThankYou'}
            <div class="event-info-label span3">{$field.groupTitle} </div><div class="event-info-detail span9">
          {/if}
      ...
      {elseif $field.options_per_line != 0}
          <div class="crm-section {$n}-section row-fluid">
            ...
            {/if}
            <div class="field-label option-label span3">{$form.$n.label}</div>
            <div class="content event-info-detail span9">
         ...
         {else}
           <div class="crm-section {$n}-section row-fluid">
             ...
             {if $field.help_pre && $action neq 4 && $action neq 1028}
               &nbsp;&nbsp;<span class="description">{$field.help_pre}</span>
             {/if}
             <div class="field-label span3">{$form.$n.label}</div>
             <div class="content event-info-detail span9">
