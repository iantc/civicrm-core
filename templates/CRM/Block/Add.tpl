...
<form action="{$postURL}" method="post">
        ...
        <input type="text" name="first_name" id="qa_first_name" class="form-text span11" maxlength="64" />
        <label for="qa_last_name">{ts}Last Name{/ts}</label>
        <input type="text" name="last_name" id="qa_last_name" class="form-text required span11" maxlength="64" />
        <label for="qa_email">{ts}Email{/ts}</label>
        <input type="text" name="email[1][email]" id="qa_email" class="form-text span11" maxlength="64" />
        ...
        <input type="submit" name="_qf_Contact_next" value="{ts}Save{/ts}" class="form-submit btn" />
    </form>
</div>
